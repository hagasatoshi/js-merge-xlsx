    ...
    _createClass(SpreadSheet, [{
        ...
        value: function simple_render(bind_data, jszip_option) {
            ...
            return _bluebird2['default'].resolve().then(function () {
                return _this2.excel.file('xl/sharedStrings.xml', _mustache2['default'].render(_this2.sharedstrings_str, bind_data)).generate(jszip_option);
            });
        }
        ...
        value: function bulk_render_multi_file(bind_data_array, jszip_option) {
            ...
            _underscore2['default'].each(bind_data_array, function (bind_data) {
                all_excels.file(bind_data.name, _this3.simple_render(bind_data.data, jszip_option));
            });
            return _bluebird2['default'].resolve().then(function () {
