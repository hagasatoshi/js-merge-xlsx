...
var SpreadSheet = (function () {
    ...
    _createClass(SpreadSheet, [{
        ...
        value: function bulkMergeMultiFile(bindDataArray) {
            ...
            })) return Promise.reject('bulkMergeMultiFile() is called with invalid parameter');
        ...
        value: function addSheetBindingData(destSheetName, data) {
            ...
            //2.add sheet file.
            var renderedStrings = undefined;
            if (this.sharedstrings) {
                (function () {
                    //prepare rendered-strings
                    renderedStrings = _(_this4.commonStringsWithVariable).deepCopy();
