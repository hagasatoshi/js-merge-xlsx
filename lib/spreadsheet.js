    ...
    _createClass(SpreadSheet, [{
        ...
        value: function load(excel) {
            ...
            return Promise.props({
                ...
                _this.template_sheet_rels_data = _(_this._templateSheetRels()).deep_copy();
        ...
        key: 'simpleRender',
        value: function simpleRender(bind_data) {
            var _this2 = this;
            ...
            return Promise.resolve().then(function () {
                return _this2._simpleRender(bind_data, output_buffer);
            });
        }
        ...
        value: function bulkRenderMultiFile(bind_data_array) {
            ...
            _.each(bind_data_array, function (_ref) {
                var name = _ref.name;
                var data = _ref.data;
                return all_excels.file(name, _this3._simpleRender(data, jszip_buffer));
            });
            return Promise.resolve().then(function () {
        ...
        value: function addSheetBindingData(dest_sheet_name, data) {
            var _this4 = this;
        ...
        value: function activateSheet(sheetname) {
            ...
            var target_sheet_name = this._sheetByName(sheetname);
        ...
        value: function deleteSheet(sheetname) {
            ...
            var target_sheet = this._sheetByName(sheetname);
        ...
        value: function hasAsSharedString(target_str) {
        ...
        value: function generate(option) {
            ...
            parseString(this.excel.file('xl/sharedStrings.xml').asText()).then(function (sharedstrings_obj) {
                ...
                //sharedstring
                sharedstrings_obj.sst.si = _this6._cleanSharedStrings();
                ...
                //sheet_xmls_rels
                var str_templateSheetRels = builder.buildObject(_this6.template_sheet_rels_data);
                _.each(_this6.sheet_xmls, function (sheet) {
                    if (sheet.name) {
                        _this6.excel.file('xl/worksheets/_rels/' + sheet.name + '.rels', str_templateSheetRels);
                    }
                });
        ...
        key: '_simpleRender',
        value: function _simpleRender(bind_data) {
        ...
        value: function _availableSheetid() {
            ...
            var next_id = 'rId' + ('00' + ((max_rel['$'].Id.replace('rId', '') >> 0) + 1)).slice(-3);
            return next_id;
        }
        ...
        value: function _sheetRelsByName(sheetname) {
            var target_file_path = this._sheetByName(sheetname).path;
