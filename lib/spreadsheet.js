    ...
    _createClass(SpreadSheet, [{
        ...
        value: function load(excel) {
            ...
            return _bluebird2['default'].props({
                ...
                _this.template_sheet_rels_data = JSON.parse(JSON.stringify(_this._template_sheet_rels()));
        ...
        value: function generate(option) {
            ...
            //sheet_xmls_rels
            var str_template_sheet_rels = builder.buildObject(this.template_sheet_rels_data);
            _underscore2['default'].each(this.sheet_xmls, function (sheet) {
                if (sheet.name) {
        ...
        key: '_simple_render',
        value: function _simple_render(bind_data, option) {
            return this.excel.file('xl/sharedStrings.xml', _mustache2['default'].render(this.sharedstrings_str, bind_data)).generate(option);
        }
